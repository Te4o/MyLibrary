...
<form name="f" class="form-signin" role="form" action="<spring:url value="/login" />" method="POST">
	...
	<h2 class="form-signin-heading text-success">Enter your user name and password</h2>
