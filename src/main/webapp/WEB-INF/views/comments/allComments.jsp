...
<body class="jumbotron">
	...
	<div align="center">
    <h2 class="text-warning">${author.name}/${book.title}/List of Comments</h2>  
    <div class="btn-group">			
			<c:choose>
						...
						<tr>
			            	...
			            	<td>${comment.comment}</td>	
								<td><form:form action="comments/${comment.comment_id}" method="GET">
										<input type="submit" value="Edit Comment" class="btn btn-sm btn-info"/>
									</form:form>
								</td>
								<td><form:form action="comments/${comment.comment_id}" method="DELETE">
									<input type="submit" value="Delete Comment" class="btn btn-sm btn-info"/>
								</form:form>
							</td>
							</security:authorize>
						</tr>       
    ...
    <br/>
    <security:authorize access="hasAnyAuthority('USER','ADMIN')">	
    <a href="<c:url value='../${id_book}/comments/new' />" class="btn btn-sm btn-success">Add New Comment</a>
    </security:authorize>
